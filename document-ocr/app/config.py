...
_DEFAULT_PATH = Path(__file__).resolve().parent.parent / "config" / "defaults.toml"
...
def load(path: str | os.PathLike | None = None) -> Config:
    """Load config from TOML. Precedence: argument > env DOCPIPE_CONFIG > default."""
    resolved = Path(path or os.environ.get("DOCPIPE_CONFIG") or _DEFAULT_PATH)
